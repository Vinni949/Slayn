...
namespace Models1.Migrations
{
    ...
    [Migration("20220822094817_CreatedDbSetAddSalesReturnPositions")]
    partial class CreatedDbSetAddSalesReturnPositions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models1.Model.DemandClass", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Models1.Model.SalesReturnClass", b =>
                {
                    ...
                    b.Property<string>("CounterPartiesId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DemandClassId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("DemandClassId");

                    b.ToTable("salesReturnClass");
                });

            modelBuilder.Entity("Models1.Model.SalesReturnPositionsClass", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("SalesReturnClassId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("SalesReturnClassId");

                    b.ToTable("salesReturnPositionsClass");
                });
            ...
            modelBuilder.Entity("Models1.Model.SalesReturnClass", b =>
                {
                    b.HasOne("Models1.Model.DemandClass", null)
                        .WithMany("SalesReturn")
                        .HasForeignKey("DemandClassId");
                });

            modelBuilder.Entity("Models1.Model.SalesReturnPositionsClass", b =>
                {
                    b.HasOne("Models1.Model.SalesReturnClass", null)
                        .WithMany("SalesReturnPositions")
                        .HasForeignKey("SalesReturnClassId");
                });
            ...
            modelBuilder.Entity("Models1.Model.SalesReturnClass", b =>
                {
                    b.Navigation("SalesReturnPositions");
                });
